...
% (TODO): Further about classification and some other exotic things like
% reinforcement learning and language modeling.

% (TODO): Minimum Complexity Echo State Network paper has examples on the first
% page.
