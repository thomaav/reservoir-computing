...
% this paragraph. 2.2.2.2 in the phd has info on this. NOISEX.
...
% (TODO): Also elaborate on the noise trick in tricks of the trade by Jaeger,
% $x_{wobble}$. This is for training, though. A curiosity for regularization.

% (TODO): When trained, relatively robust to input and state noise, inherited from
% conventional neural networks. From Verstraeten's phd. But one usually uses ridge
% regression instead for regularization.
