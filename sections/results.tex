...
\begin{figure}[t!]
  ...
  \caption{
    Noise causing a decrease in performance for an ESN reservoir. When the
signal to noise ratio drops below 20dB, the performance of the reservoir
degrades in an exponential manner.
  }
...
bins consistently provide the same error rates as that of a reservoir with 50
hidden nodes and no output quantization.
...
performance disparity with increasing input scaling, the best error rates of all
