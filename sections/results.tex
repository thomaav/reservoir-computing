...
reservoirs that use material substrates must be aware of the effects the present
noise patterns may have on computational power.

% (TODO): Key point: as long as we train with noise, we become more robust.
